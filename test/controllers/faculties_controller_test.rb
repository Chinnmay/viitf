...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { education: @faculty.education, experience: @faculty.experience, name: @faculty.name } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { education: @faculty.education, experience: @faculty.experience, name: @faculty.name } }
